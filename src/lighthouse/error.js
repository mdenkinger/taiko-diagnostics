...
export const ErrorMessages = {
  ...
  pageLoadFailedWithStatusCode:
    'Lighthouse was unable to reliably load the page you requested. Make sure you are testing the correct URL and that the server is properly responding to all requests. (Status code: {statusCode})',
  pageLoadFailedWithDetails:
    'Lighthouse was unable to reliably load the page you requested. Make sure you are testing the correct URL and that the server is properly responding to all requests. (Details: {errorDetails})',
  pageLoadFailedInsecure:
    'The URL you have provided does not have valid security credentials. {securityMessages}',
  internalChromeError:
    'An internal Chrome error occurred. Please restart Chrome and try re-running Lighthouse.',
  requestContentTimeout:
    'Fetching resource content has exceeded the allotted time',
...
class LighthouseError extends Error {
  ...
  static isPageLoadError(err) {
    return (
      err.code === ERRORS.NO_DOCUMENT_REQUEST.code ||
